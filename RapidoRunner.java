class RapidoRunner{
    ...
    public static void main(String[] args) {
        ...
        Zomato rapido = new Zomato();
		double price = rapido.getPriceByFoodName("chapatti");
	    System.out.println("Food price:"+price);
	   
        double totalAmount = rapido.getTotalAmountByPriceAndQuantity(price,5);
	    System.out.println("Total Amount: " + totalAmount);
	   
        double finalAmount = rapido.applyDiscount(totalAmount,10);
        ...
        double totalAmountt = food.getTotalAmountByPriceAndQuantity(pricee,8);
        ...
        double totalAmounttt = items.getTotalAmountByPriceAndQuantity(priceee,7);
        ...
        double totalAmountttt = veraitty.getTotalAmountByPriceAndQuantity(priceeee,6);
