class  HungryJIRunner{

    public static void main(String[] args) {

          HungryJI hungry = new   HungryJI();
		double price = zomato.getPriceByFoodName("chapatti");
	    System.out.println("Food price:"+price);
	   
        double totalAmount = hungry.getTotalAmountByPriceAndQuantity(price,3);
	    System.out.println("Total Amount: " + totalAmount);
	   
        double finalAmount = hungry.applyDiscount(totalAmount,10);
	    System.out.println("Final Amount after Discount: " + finalAmount);
		System.out.println("---------------------------------------");
		
		
		
		  HungryJI food = new   HungryJI();
		...
		System.out.println("---------------------------------------");
		  ...
		  HungryJI veraitty = new   HungryJI();
